...
while ( have_posts() ) : the_post(); ?>
    ...
    if( $qry->have_posts() ){ ?>    
        <div class="related-portfolio">
        	<div class="related-portfolio-title"><?php esc_html_e( 'Related Projects', 'blossom-shop-pro' ); ?></div>
                    		...
                    		<div class="portfolio-item-inner">
                                <a href="<?php the_permalink(); ?>">
                                    <?php if( has_post_thumbnail() ){
                                        ...
                                        blossom_shop_pro_get_fallback_svg( $related_image_size );
                                    } ?>
                                </a>
