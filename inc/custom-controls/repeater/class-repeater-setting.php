<?php
/**
 * Blossom Shop Pro Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Shop_Pro_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Shop_Pro_Repeater_Setting extends WP_Customize_Setting {
