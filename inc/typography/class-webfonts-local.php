 ...
 */
final class Blossom_Shop_Pro_Webfonts_Local{
	...
	public function add_styles() {
		...
		foreach( $hosted_fonts as $family ){
			...
			$css .= Blossom_Shop_Pro_Google_Local::init( $family )->get_css();
		}

		// If we've got CSS, add to the footer.
		if ( $css ) {
			echo '<style id="blossom-shop-pro-local-webfonts">' . $css . '</style>'; // WPCS: XSS ok.
		}
	}
}